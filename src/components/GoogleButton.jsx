...
export default function GoogleButton({ label = "Continue with Google" }) {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="w-full flex items-center justify-center gap-3 border border-[#e5e7eb] rounded-md py-2.5 text-sm font-medium text-[var(--color-text-primary)] hover:bg-[#f3f4f6] transition-colors"
    >
